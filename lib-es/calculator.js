...
export function genAlpha(transport, alphaLen, isToken) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, transport.send(cmd.cla, cmd.GenAlpha, alphaLen, p2, buf)];
        });
    });
}
export function setAlpha(transport, index, data) {
    return __awaiter(this, void 0, void 0, function () {
        var buf;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, transport.send(cmd.cla, cmd.SetAlpha, index, 0x00, buf)];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
}
export function getAlpha(transport, alphaLen, isToken) {
    return __awaiter(this, void 0, void 0, function () {
        var buf, p2, i, res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, transport.send(cmd.cla, cmd.GetAlpha, i, p2, buf)];
                case 2:
                    res = _a.sent();
                    console.log(res);
                    _a.label = 3;
...
export function calculateKeyImage(transport, encryptKmB64, coinPubKeyB64) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, transport.send(cmd.cla, cmd.KeyImage, 0x00, 0x00, buffer)];
                case 1:
                    res = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, transport.send(cmd.cla, cmd.CalculateC, 0x00, i, h)];
                case 3:
                    msg_1 = _a.sent();
                ...
                case 4:
                    i++;
                    return [3 /*break*/, 2];
                case 5: return [4 /*yield*/, transport.send(cmd.cla, cmd.CalculateC, 0x01, params.length - 1, pedComG)];
                case 6:
                    msg = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    h = Buffer.from(params[i], "base64");
                    return [4 /*yield*/, transport.send(cmd.cla, cmd.CalculateCCA, 0x00, i, h)];
                case 3:
                    msg_2 = _a.sent();
                ...
                case 4:
                    i++;
                    return [3 /*break*/, 2];
                case 5: return [4 /*yield*/, transport.send(cmd.cla, cmd.CalculateCCA, 0x01, params.length - 2, pedComG)];
                case 6:
                    msg = _a.sent();
                    result.push(msg.subarray(0, 32));
                    return [4 /*yield*/, transport.send(cmd.cla, cmd.CalculateCCA, 0x01, params.length - 1, pedComG)];
                case 7:
                    msg = _a.sent();
                    result.push(msg.subarray(0, 32));
                    return [2 /*return*/, arrayConcat(result)];
...
export var calculateFirstC = function (transport, params, isToken) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    return [2 /*return*/, isToken ? _calculateFirstC_CA(transport, params) : _calculateFirstC(transport, params)];
}); }); };
export function calculateR(transport, coinLen, cPi, isToken) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, transport.send(cmd.cla, cmd.CalculateR, p1, i, buf)];
                case 3:
                    msg = _a.sent();
                    result.push(msg.subarray(0, 32));
                    _a.label = 4;
...
export function calculateCoinPrivKey(transport, coinsH, inputLen) {
    return __awaiter(this, void 0, void 0, function () {
        var i, buf, i, buf;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, transport.send(cmd.cla, cmd.GenCoinPrivateKey, 0x00, i, buf)];
                case 2:
                    _a.sent();
                    _a.label = 3;
                case 3:
                ...
                case 5:
                    ...
                    buf = Buffer.from(coinsH[i], "base64");
                    return [4 /*yield*/, transport.send(cmd.cla, cmd.GenCoinPrivateKey, 0x01, i, buf)];
                case 6:
                    _a.sent();
                    _a.label = 7;
                case 7:
...
export function signSchnorr(transport, pedRand, pedPriv, randomness, message) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, transport.send(cmd.cla, cmd.SignSchnorr, 0x00, 0x00, buf)];
